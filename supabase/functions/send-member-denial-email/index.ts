// ─────────────────────────────────────────────────────────────────────────────
// HIBCW — send-member-denial-email  (Supabase Edge Function)
//
// Called by admin.html when a member application is rejected.
...
//
// Deploy:
//   supabase functions deploy send-member-denial-email --no-verify-jwt
...
Deno.serve(async (req: Request): Promise<Response> => {
  ...
  const memberName = full_name || "Applicant";
...
<head>
  ...
  <title>HIBCW — Application Update</title>
</head>
<body style="margin:0;padding:0;background:#0b1524;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;">
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#0b1524;padding:32px 0;">
    ...
    <table width="600" cellpadding="0" cellspacing="0"
      ...
      <tr>
        <td style="background:#111e30;padding:28px 32px 0;">
          ...
          <p style="margin:0 0 16px;color:#7a8fa6;font-size:14px;line-height:1.7;">
            Thank you for your interest in becoming a verified member of the
            Hawaiʻi Island Business Crime Watch network.
          </p>
          <p style="margin:0 0 24px;color:#7a8fa6;font-size:14px;line-height:1.7;">
            ...
            We encourage you to review your submission and apply again — the more members our
            network has, the safer our community becomes.
          </p>
        </td>
      </tr>
      ...
      <!-- TRY AGAIN CTA -->
      <tr>
        <td style="background:#111e30;padding:0 32px 20px;">
            ...
            <tr>
              <td style="padding:14px 20px;">
                <p style="margin:0 0 14px;color:#7a8fa6;font-size:13px;line-height:1.6;">
                  You are welcome to submit a new application at any time. Please make sure your
                  information is complete and accurate before resubmitting.
                </p>
                <table width="100%" cellpadding="0" cellspacing="0">
                  <tr>
                    <td style="background:rgba(0,201,167,.08);border:1px solid rgba(0,201,167,.25);border-radius:6px;padding:11px 16px;text-align:center;">
                      ...
                      <p style="margin:4px 0 0;color:#7a8fa6;font-size:11px;">hibcw.kiaahilo.org/apply.html</p>
                    </td>
                  </tr>
                </table>
              </td>
        ...
        <td style="background:#111e30;padding:0 32px 28px;">
          <table width="100%" cellpadding="0" cellspacing="0"
            ...
            <tr>
              <td style="padding:14px 20px;">
                <p style="margin:0 0 14px;color:#7a8fa6;font-size:13px;line-height:1.6;">
                  Even without a verified membership, you can still view the HIBCW crime map
                  and submit incident reports anonymously. Your reports help keep
                  Hawaiʻi Island businesses and neighborhoods safer for everyone.
                </p>
                <table width="100%" cellpadding="0" cellspacing="0">
                  <tr>
                    <td style="background:rgba(245,166,35,.08);border:1px solid rgba(245,166,35,.25);border-radius:6px;padding:11px 16px;text-align:center;">
                      <a href="https://hibcw.kiaahilo.org"
                        ...
                        View the Map &amp; Report Anonymously
                      </a>
                      <p style="margin:4px 0 0;color:#7a8fa6;font-size:11px;">No account required · Always free</p>
                    </td>
                  </tr>
                </table>
              </td>
...
Thank you for your interest in becoming a verified member of the Hawaiʻi Island Business Crime Watch network.

After reviewing your application, we are unable to approve your membership at this time. We encourage you to review your submission and apply again — the more members our network has, the safer our community becomes.

To submit a new application, visit:
https://hibcw.kiaahilo.org/apply.html

─────────────────────────────────────
Did you know? You can still help your community!

Even without a verified membership, you can view the HIBCW crime map and submit incident reports anonymously. Your reports help keep Hawaiʻi Island businesses and neighborhoods safer for everyone.

View the map and report anonymously (no account required):
...
hibcw.kiaahilo.org`;
  ...
  const resendRes = await fetch("https://api.resend.com/emails", {
    ...
    body: JSON.stringify({
      from:    RESEND_FROM,
      to:      [email],
      subject: "Update on your HIBCW member application",
      html:    htmlBody,
      text:    textBody,
    }),
  });
